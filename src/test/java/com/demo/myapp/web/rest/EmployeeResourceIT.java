...
import static com.demo.myapp.domain.EmployeeAsserts.*;
import static com.demo.myapp.web.rest.TestUtil.createUpdateProxyForBean;
...
class EmployeeResourceIT {
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).hireDate(UPDATED_HIRE_DATE).commissionPct(UPDATED_COMMISSION_PCT);
