...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('regularly nor');
      cy.get(`[data-cy="title"]`).should('have.value', 'regularly nor');

      cy.get(`[data-cy="description"]`).type('during spark ha');
      cy.get(`[data-cy="description"]`).should('have.value', 'during spark ha');
