...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Internal Mobility Manager');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Internal Mobility Manager');

      cy.get(`[data-cy="minSalary"]`).type('30794');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '30794');

      cy.get(`[data-cy="maxSalary"]`).type('2929');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '2929');
