...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bf43573b-188f-411a-82f6-f3d225ebb6cc' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('660e95e2-0b70-44e2-9c25-a6a3288bea0f');
      cy.get(`[data-cy="name"]`).should('have.value', '660e95e2-0b70-44e2-9c25-a6a3288bea0f');
