...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'boohoo' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('legislature noxious');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'legislature noxious');
