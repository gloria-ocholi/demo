...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('beyond bustling');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'beyond bustling');

      cy.get(`[data-cy="postalCode"]`).type('aw');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'aw');

      cy.get(`[data-cy="city"]`).type('Blickcester');
      cy.get(`[data-cy="city"]`).should('have.value', 'Blickcester');

      cy.get(`[data-cy="stateProvince"]`).type('before');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'before');
